...
| `F-025` — One: identidade e fundação de design | Selecionada em 25/08/2026 (Issue #46) | `READY_FOR_PLANNING` | [FDD 025](docs/fdd/025-o-nome-que-a-tela-ainda-nao-sabia.md) | Gate de design atravessado: revisão 3 do DAP aprovada em 25/08/2026, visual e cópia. |
