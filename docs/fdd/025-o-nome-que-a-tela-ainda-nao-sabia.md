...
`DONE` desde 25/08/2026 — implementada, validada, revisada e **mergeada** (PR #47, ADR 0069): a
decisão humana no merge foi tomada. O gate de design foi atravessado antes: o
