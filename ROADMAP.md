...
| `F-026` — Aplicar o One Design System ao shell real | Selecionada em 26/08/2026 (Issue #60) | `PLANNING` | [FDD 026](docs/fdd/026-a-pele-que-o-shell-ainda-nao-vestiu.md) | DAP r1 aprovado (26/08); plano real produzido; aguarda aprovação de plano (`PLAN_VALIDATION: PENDENTE`). |
