...
- **Pendente (Fase 4 / ADR 0004):** sync OAuth somente-leitura do Google Drive, com uma pasta permitida por projeto. Enquanto ele não existe, o arquivo do Drive continua sendo só metadado com link, e o que é indexável é o que foi enviado pela administração.
