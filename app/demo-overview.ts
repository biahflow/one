...
export const DEMO_OVERVIEW: Overview = {
  ...
  pendings: [
    { title: "Aprovar fluxo de exceções", description: null, owner: "Acme Brasil", state: "open", stateLabel: "Aberta", priority: "high", priorityLabel: "Alta", origin: "biahflow", openedByMessageId: null, openedByConversationId: null, age: "há 2 dias" },
    { title: "Enviar lista de usuários piloto", description: null, owner: "Acme Brasil", state: "open", stateLabel: "Aberta", priority: "medium", priorityLabel: "Média", origin: "biahflow", openedByMessageId: null, openedByConversationId: null, age: "há 4 dias" },
    { title: "Validar cálculo de economia", description: null, owner: "Portal Labs", state: "open", stateLabel: "Aberta", priority: "low", priorityLabel: "Baixa", origin: "biahflow", openedByMessageId: null, openedByConversationId: null, age: "há 5 dias" },
    { title: "Definir alçada de aprovação", description: null, owner: "Portal Labs", state: "resolved", stateLabel: "Resolvida", priority: "medium", priorityLabel: "Média", origin: "biahflow", openedByMessageId: null, openedByConversationId: null, age: "há 9 dias" },
  ],
